...
struct CountryRow_Previews: PreviewProvider {
    static var previews: some View {
        CountryRow(countryStat: CaseStats.init(id: "test", name: nil, iso: nil, countryCode: nil, newConfirmed: 100, totalConfirmed: 100, newDeaths: 100, totalDeaths: 100, newRecovered: 100, totalRecovered: 100, date: Date()), isAddedToWatchlist: false)
    }
}
